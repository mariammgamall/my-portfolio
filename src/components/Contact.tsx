      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <motion.div 
            ...
            className="lg:col-span-5 space-y-8 flex flex-col justify-between text-start"
          >
            ...
            <div className="space-y-4 my-8 lg:my-0">
              <div className="flex items-center gap-4">
                <div className="p-3.5 rounded-xl bg-slate-100 dark:bg-slate-900 text-accent-indigo dark:text-accent-teal border border-slate-200/40 dark:border-slate-800 flex-shrink-0">
                  <FaPhone size={16} />
                </div>
                <div>
                  <h4 className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wide">{t.contact.phone}</h4>
                  <p className="text-sm md:text-base font-semibold text-slate-850 dark:text-slate-250" dir="ltr">+20 128 087 3442</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wide">{t.contact.email}</h4>
                  <a 
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wide">{t.contact.location}</h4>
                  <p className="text-sm md:text-base font-semibold text-slate-850 dark:text-slate-250">{t.contact.locationVal}</p>
                </div>
              </div>
            </div>
                ...
                {!submitted ? (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label htmlFor="name" className="text-xs md:text-sm font-bold text-slate-700 dark:text-slate-300">{t.contact.nameLabel}</label>
                        <input
                          type="text"
                          id="name"
                          name="name"
                      ...
                      <div className="space-y-2">
                        <label htmlFor="email" className="text-xs md:text-sm font-bold text-slate-700 dark:text-slate-300">{t.contact.emailLabel}</label>
                        <input
                          type="email"
                          id="email"
                          name="email"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="message" className="text-xs md:text-sm font-bold text-slate-700 dark:text-slate-300">{t.contact.msgLabel}</label>
                      <textarea
                        id="message"
                        name="message"
                        rows={5}
                  ...
                  >
                    ...
                    <button
                      ...
                      className="mt-6 px-5 py-2.5 rounded-xl border border-slate-300 dark:border-slate-800 text-slate-700 dark:text-slate-350 text-xs md:text-sm font-semibold hover:bg-slate-50 dark:hover:bg-slate-900/50 hover:scale-105 active:scale-95 transition-all cursor-pointer"
                    >
